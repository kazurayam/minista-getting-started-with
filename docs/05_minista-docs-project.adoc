...
公式ドキュメントを見ればministaがたくさんの機能（プラグイン）を提供することがわかる。しかしどう使えばいいのか、よくわからない。実際に動くサンプルを見たいなあ... そう思ったら link:https://github.com/qrac/minista/tree/main/docs[misista/docs] フォルダを掘ってみると良い。宝物がゴロゴロ転がっている予感がします。
